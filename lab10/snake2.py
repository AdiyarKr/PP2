...
bg = pg.image.load('/Users/adiyarkarim/Downloads/back (1).png')
bg = pg.transform.scale(bg, (w, h))
gameover = pg.image.load('/Users/adiyarkarim/Downloads/game_over (1).jpeg')
...
class Food:
    ...
    def draw2(self):
        ...
        self.r = randint(1, 3)
        self.image = pg.image.load('/Users/adiyarkarim/Downloads/food2.png')
...
class Wall:
    def __init__(self, x, y):
        self.x, self.y = x, y
        self.pic = pg.image.load('/Users/adiyarkarim/Downloads/wall1 (1).png')
...
s = Snake()
f = Food(pg.image.load('/Users/adiyarkarim/Downloads/food3.png'))
...
while is_running:
    ...
    my_walls = open('/Users/adiyarkarim/Downloads/wall1 (1).txt', 'r').readlines() #әр жолды жеке лист ретінде оқиды
    walls = []
